...
// Indica si esta instalación ya recibió autorización de Drive anteriormente.
// No contiene credenciales: sólo evita pedir consentimiento completo cada vez.
export function hasKnownGoogleGrant(): boolean {
  return localStorage.getItem(GOOGLE_GRANT_KEY) === "true";
}
