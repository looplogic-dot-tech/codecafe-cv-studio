...
import { prepareBlankStartupWorkspaceFromStorage } from "./startupBlank";
...
// Preserve the complete library, but never reopen an old CV in the editor.
prepareBlankStartupWorkspaceFromStorage();
prepareLinkedWorkspaceFromStorage();
