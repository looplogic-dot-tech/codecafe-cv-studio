...
const libraryCopy: Record<"es" | "en", LibraryCopy> = {
  es: {
    ...
    inheritBasics: "Heredar datos básicos de este perfil", cvsTab: "CVs", professionalTab: "Biblioteca Profesional",
  },
  en: {
    ...
    inheritBasics: "Reuse this profile's basic information", cvsTab: "CVs", professionalTab: "Professional Library",
  },
};
