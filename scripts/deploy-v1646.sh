...
BRANCH="release/v1.6.4.6"
WORK="$HOME/codecafe-v1646"
STAMP="$(date +%Y%m%d-%H%M%S)"
ROLLBACK="$HOME/codecafe-v1646-frontend-$STAMP"
...
echo "============================================================"
echo " CODECAFE CV STUDIO 1.6.4.6"
echo " CORRECTION: REMOVE ALTERNATING BLANK PRINT/PDF PAGES"
echo "============================================================"
...
print('PASS: blank-page print correction present')
...
echo "============================================================"
echo " CODECAFE CV STUDIO 1.6.4.6 DEPLOYED"
echo "✓ alternating blank PDF pages corrected"
echo "✓ Live Preview / Print Editor pagination retained"
