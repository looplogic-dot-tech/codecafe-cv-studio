...
echo "============================================================"
echo " CODECAFE CV STUDIO 1.6.4.10.1"
echo " CORRECTION: INLINE FORMATTER ONLY — PRINT LOCKED"
echo "============================================================"
df -h /
...
assert Path('scripts/LOCK-PRINT-v16410.txt').is_file()
...
print('PASS: print subsystem lock present')
PY
...
echo "============================================================"
echo " CODECAFE CV STUDIO 1.6.4.10.1 DEPLOYED"
