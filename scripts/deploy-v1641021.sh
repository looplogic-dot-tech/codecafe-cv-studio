...
WORK="$HOME/codecafe-v1641021"
STAMP="$(date +%Y%m%d-%H%M%S)"
ROLLBACK="$HOME/codecafe-v1641021-frontend-$STAMP"
...
echo "============================================================"
echo " CODECAFE CV STUDIO 1.6.4.10.2.1"
echo " CORRECTION: TYPESCRIPT-SAFE INLINE FORMATTER — PRINT LOCKED"
echo "============================================================"
df -h /
...
assert pkg['version']=='1.6.4.10.2.1'
app=Path('src/App.tsx').read_text(encoding='utf-8')
assert 'function InlineText({ value }: { value: string }) {' in app
...
assert '} : { value: string }) {' not in app
assert Path('dist/index.html').is_file()
print('PASS: TypeScript syntax intact')
print('PASS: inline bold and hyperlinks compiled')
...
echo "============================================================"
echo " CODECAFE CV STUDIO 1.6.4.10.2.1 DEPLOYED"
echo "✓ TypeScript syntax intact"
